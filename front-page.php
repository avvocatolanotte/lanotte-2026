...
function lanotte_render_section_risorse() {
    ...
    $cards = [
        ['url' => get_permalink(get_page_by_path('calcolatori')) ?: home_url('/calcolatori/'), 'icon' => '📊', 't' => '21 Calcolatori giuridici', 'd' => 'Successioni, parcelle forensi, danni, ISTAT, interessi e scadenze. Gratuiti, con anteprima e PDF.', 'cta' => 'Apri i calcolatori'],
