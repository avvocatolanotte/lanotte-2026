...
<section style="background:#fafaf7;padding:60px 0">
  <div class="container">
    ...
    <div class="calc-grid">
      ...
      <a href="<?php echo esc_url("$calc_base/imposta-successione/"); ?>" class="calc-card cat-4"><div class="calc-icon">📜</div><h3>Imposta di Successione</h3><p>Aliquote, franchigie, prima casa, ipocatastali</p><span class="calc-tag">D.Lgs. 346/1990 + D.Lgs. 139/2024</span></a>
